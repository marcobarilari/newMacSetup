...
## 'https://github.com/fink/scripts/releases/tag/setup/0.44.0'
## 
# 
# master for MacAppStore {
# xxxURL="macappstore:xxx"}
# 
# master for web download {
# xxxVersion="xxx"
# xxxPKGPath="xxx.pkg"
# FileName="xxx-${xxxVersion}.dmg"
# xxxSourceDLP="https://xxx/${XQuartzFileName}"}
# 
## history: 
## 2019-01-20 first version in progress
